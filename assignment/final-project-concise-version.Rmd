...
```{r}
source("assignment/functions.R")
```

```{r}
load(file.path(clean_data_dir, "assignment/def_clean_df.Rdata")) # same as def_clean but without the geometry, just dataframe

load(file.path(clean_data_dir, "assignment/def_clean.Rdata"))

load(file.path(clean_data_dir, "assignment/la_clean.Rdata"))
